package tempest.ui.collections
{
	...
	public class SortField extends EventDispatcher
	{
		 ...
		 *  @productversion Flex 3
		 */
		internal function get usingCustomCompareFunction():Boolean
		{
			return _usingCustomCompareFunction;
		}
		
		internal function internalCompare(a:Object, b:Object):int
		{
		 ...
		 *  @productversion Flex 3
		 */
		internal function getArraySortOnOptions():int
		{
		 ...
		 */
		internal function initCompare(obj:Object):void
		{
...
//		}
		...
		private function nullCompare(a:Object, b:Object):int
		{
			...
			{
				throw new Error("collections Error: noComparatorSortField " + name);
			}
		}	
