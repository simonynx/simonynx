...
package GameUI.Modules.Stall.Proxy {
    ...
    public class StallDownGridManager extends Proxy {

        public static const NAME:String = "StallDownGridManager";
        ...
        public function StallDownGridManager(_arg1:Array, _arg2:Sprite){
            gridList = new Array();
            super(NAME);
            this.gridList = _arg1;
        ...
        private function dragDroppedHandler(_arg1:DropEvent):void{
            ...
            switch (_arg1.Data.type){
                case "bag":
                    facade.sendNotification(StallEvents.DELDOWNSTALLITEM, {
        ...
        public function removeAllFrames():void{
            var _local1:int;
            while (_local1 < StallConstData.DOWN_GRID_NUM) {
                if (StallConstData.GridDownUnitList[_local1].Grid.parent.getChildByName("redFrame")){
                    StallConstData.GridDownUnitList[_local1].Grid.parent.removeChild(StallConstData.GridDownUnitList[_local1].Grid.parent.getChildByName("redFrame"));
                };
                if (StallConstData.GridDownUnitList[_local1].Grid.parent.getChildByName("yellowFrame")){
                    StallConstData.GridDownUnitList[_local1].Grid.parent.removeChild(StallConstData.GridDownUnitList[_local1].Grid.parent.getChildByName("yellowFrame"));
                };
                _local1++;
            };
        }
        ...
        public function showItems(_arg1:Array):void{
            ...
            while (_local3 < _arg1.length) {
                if (_arg1[_local3] == undefined){
                    ...
                    _local2.name = ("downitem" + _local3);
                    _local2.Num = _arg1[_local3].Count;
                    _local2.x = (StallConstData.GridDownUnitList[_local3].Grid.x + 2);
                    _local2.y = (StallConstData.GridDownUnitList[_local3].Grid.y + 2);
                    _local2.Id = _arg1[_local3].id;
                    _local2.IsBind = _arg1[_local3].isBind;
                    _local2.Type = _arg1[_local3].type;
                    _local2.IsLock = false;
                    StallConstData.GridDownUnitList[_local3].Item = _local2;
                    StallConstData.GridDownUnitList[_local3].IsUsed = true;
        ...
        private function doubleClickHandler(_arg1:MouseEvent):void{
            ...
            var _local3:uint;
            while (_local3 < StallConstData.goodDownList.length) {
                if (((!((StallConstData.goodDownList[_local3] == null))) && (!((StallConstData.goodDownList[_local2] == null))))){
                    if (StallConstData.goodDownList[_local3].id == StallConstData.goodDownList[_local2].id){
                        sendNotification(EventList.BAGITEMUNLOCK, StallConstData.goodDownList[_local3].id);
            ...
            removeAllItem();
            showItems(StallConstData.goodDownList);
        }
        public function refreshItemNum(_arg1:uint, _arg2:uint):void{
            StallConstData.GridDownUnitList[_arg1].Item.Num = String(_arg2);
        }
        private function disableMouseDown(_arg1:MouseEvent):void{
            ...
            if (gridList[_local14].Item){
                ...
                StallConstData.SelectedDownItem = gridList[_local14];
                sendNotification(StallEvents.SELECTDOWNITEM);
                sendNotification(StallEvents.REFRESHDOWNMONEY);
        ...
        private function returnItem(_arg1:ItemBase):void{
            ...
            StallConstData.SelectedDownItem = StallConstData.GridDownUnitList[_arg1.Pos];
        }
        ...
        private function enableMouseDown(_arg1:MouseEvent):void{
            ...
            if (gridList[_local12].Item){
                ...
                StallConstData.SelectedDownItem = gridList[_local12];
                sendNotification(StallEvents.REFRESHDOWNMONEY);
        ...
        public function removeItem(_arg1:uint):void{
            gridSprite.removeChild(gridSprite.getChildByName(("downitem" + _arg1)));
            if (StallConstData.GridDownUnitList[_arg1].Grid.parent.getChildByName("redFrame")){
                StallConstData.GridDownUnitList[_arg1].Grid.parent.removeChild(StallConstData.GridDownUnitList[_arg1].Grid.parent.getChildByName("redFrame"));
            };
            if (StallConstData.GridDownUnitList[_arg1].Grid.parent.getChildByName("yellowFrame")){
                StallConstData.GridDownUnitList[_arg1].Grid.parent.removeChild(StallConstData.GridDownUnitList[_arg1].Grid.parent.getChildByName("yellowFrame"));
            };
            StallConstData.GridDownUnitList[_arg1].Item = null;
            StallConstData.GridDownUnitList[_arg1].IsUsed = false;
        }
        private function onMouseMove(_arg1:MouseEvent):void{
            if (StallConstData.SelectedDownItem){
                if ((((_arg1.currentTarget.name.split("_")[0] == "stalldown")) && ((_arg1.currentTarget.name.split("_")[1] == StallConstData.SelectedDownItem.Index)))){
                    return;
                };
            };
        ...
        public function removeAllItem():void{
            ...
            while (_local3 < StallConstData.DOWN_GRID_NUM) {
                if (StallConstData.GridDownUnitList[_local3].Grid.parent.getChildByName("redFrame")){
                    StallConstData.GridDownUnitList[_local3].Grid.parent.removeChild(StallConstData.GridDownUnitList[_local3].Grid.parent.getChildByName("redFrame"));
                };
                if (StallConstData.GridDownUnitList[_local3].Grid.parent.getChildByName("yellowFrame")){
                    StallConstData.GridDownUnitList[_local3].Grid.parent.removeChild(StallConstData.GridDownUnitList[_local3].Grid.parent.getChildByName("yellowFrame"));
                };
                StallConstData.GridDownUnitList[_local3].Item = null;
                StallConstData.GridDownUnitList[_local3].IsUsed = false;
                _local3++;
            };
        }
