...
//- PUBLIC & INTERNAL METHODS -----------------------------------------------------------------------------
		...
		{
			fadeTween = GTweener.to(channel, $fadeLength, {volume: $volume, onComplete: fadeComplete, onCompleteParams: [$stopOnComplete]});
		}
...
//- GETTERS & SETTERS -------------------------------------------------------------------------------------
		 ...
		 *
		 */
		public function get fadeTween():GTween
		{
			return _fadeTween;
		}
		 ...
		 *
		 */
		public function set fadeTween($val:GTween):void
		{
			if ($val == null)
