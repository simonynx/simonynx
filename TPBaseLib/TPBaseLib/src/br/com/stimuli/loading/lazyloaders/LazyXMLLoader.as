package br.com.stimuli.loading.lazyloaders
{
	...
	{
		private static const log:ILogger = TLog.getLogger(LazyXMLLoader);

		function LazyXMLLoader(url:*, name:String, numConnections:int = BulkLoader.DEFAULT_NUM_CONNECTIONS, logLevel:int = TLog.LEVEL_ERROR)
		{
