package tempest.utils
{
	...
	public class Stats extends Sprite
	{
		...
		private function onAddedToStage(e:Event):void
		{
			...
			graphics.drawRect(0, 0, 90, 40);
			graphics.endFill();
			ver = new Sprite();
			ver.graphics.beginFill(0x33);
			ver.graphics.drawRect(0, 0, 90, 30);
			...
			memText.text = "MEM: ";
			addChild(memText);
			graph = new BitmapData(90, 50, false, 0x33);
