package tempest.common.rsl
{
	...
	{
		private static const log:ILogger = TLog.getLogger(TRslManager);
		 ...
		 * @return
		 */
		public static function load(key:String, url:String, onComplete:Function = null, onProgress:Function = null, onError:Function = null, decode:Function = null, moduleType:String = "res"):TRslVO
		{
...
//					$module.loader = null;
		...
		public static function getDefinition(className:String, moduleName:String = ""):Object
		{
			if (moduleName != "")
			{
				...
				{
					log.error("getDefinition:rsl模块不存在 className:" + className + " rslName:" + moduleName);
					return null;
				}
