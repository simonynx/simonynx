package org.granite.math
{
	...
	public final class BigInteger implements IBigNumber
	{
		///////////////////////////////////////////////////////////////////////
		// Constants.
		...
		private static function newBigInteger(sign:int, mbi:MutableBigInteger, constants:Boolean = true):BigInteger
		{
			if (constants)
			{
